...
function initJitsiMeetExternalAPI(roomName, displayName, parentElementId) {
    ...
    const options = {
        ...
        configOverwrite: { prejoinPageEnabled: false, requireDisplayName: true },
