...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const filterSidebarSearchInput = document.querySelector('.col-xl-3 .input-group input[type="search"]') as HTMLInputElement | null;
    ...
    if (clearFiltersBtn) {
        clearFiltersBtn.addEventListener('click', (e) => {
            ...
            document.querySelectorAll('input[type="search"]').forEach(input => (input as HTMLInputElement).value = '');
